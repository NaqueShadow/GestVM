            ...
            <table class="table table-success table-hover table-striped">
                ...
                @foreach($attributions as $attribution)
                    <tr>
                        ...
                        <td> {{substr($attribution->mission->objet,0,30).'...'}} </td>
                        <td> {{$attribution->mission->villeDesti->nom}} - {{$attribution->mission->villeDep->nom}} </td>
                        <td> {{$attribution->idVehicule}} </td>
                        <td> {{$attribution->chauffeur->nom}} {{substr($attribution->chauffeur->prenom,0,20).'...'}} </td>
                        <td>
