            ...
            <div class="">
                <form class="" method="post" action="{{ route('agentMiss.filtreDemande') }}" id="form">
                    ...
                    <div  class="form-group form-row mb-0">
                        <div class="col">
                            <a href="{{ route('mission.create') }}" class="m-0">
                                <button type="button" class="btn btn-success pb-1" >+ Nouvelle requête</button>
                            </a>
                        </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-sm-right">
                                    <a href="{{ route('mission.show', ['mission' => $mission->id]) }}" class="dropdown-item">
                                        <button class="btn btn-link text-success p-1 p-1" title="détails">
                                    ...
                                    @if(!empty($mission->attributions->first()) || $mission->validation != 'Aucun avis')
                                        <span class="col text-right text-primary h6">--</span>
                                    @else
                                        <a href="mission/{{ $mission->id }}/edit" class="dropdown-item">
                                            <button class="btn btn-link text-info p-1 p-1" title="éditer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                                                </svg> éditer
                                            </button>
                                        </a>
                                        <a href="/mission/{{ $mission->id }}/destroy" class="dropdown-item">
                                            <button class="btn btn-link text-danger p-1 p-1" title="supprimer">
