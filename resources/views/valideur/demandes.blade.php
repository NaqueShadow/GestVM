...
@section('content')
    ...
    <div class="card mt-2 h-100 align-content-center text-dark" style="margin: auto; box-shadow: 1px 1px 2px mediumseagreen; border-radius: 15px; width: 100%;">
        <div class="card-header bg-light pt-0 pb-0">
            <div class="">
                {{--<form class="" method="post" action="{{ route('valideur.filtreDemande') }}" id="form">
                    @csrf
                ...
                <div class="h3 text-success text-center">Demandes en attente de validation</div>
            </div>
        </div>
            ...
            <table class="table table-striped table-hover">
                ...
                @foreach($missions as $mission)
                    <tr>
                        ...
                        <td> {{strlen($mission->objet) < 31 ?$mission->objet:substr($mission->objet,0,30).'...'}} </td>
