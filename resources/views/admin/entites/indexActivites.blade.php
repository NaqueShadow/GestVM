                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm-right">
                                        <a href="{{ route('activite.edit', ['activite' => $activite->code]) }}" class="dropdown-item">
                                        ...
                                        <form method="post" class="dropdown-item" action="{{ route('activite.destroy', ['activite' => $activite->code]) }}" style="display: inline;">
                                            @csrf
                                            @method ('DELETE')
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Enregistrement d'une activité</h5>
                    ...
                    <div class="modal-body">
                        <form class="mt-5" method="post" action="{{route('activite.store')}}" id="form">
                            @csrf
