        ...
        <div class="card-header bg-light pt-0 pb-0">
            <div class="row">
                <div class="col">
                    ...
                    <button type="button" class="btn btn-success pb-1" data-toggle="modal" data-target="#fenetre2">
                        + depuis un classeur
                    </button>
                </div>
                <form class="col-4" method="post" action="{{route('admin.rechercheAgent')}}" id="form">
                    @csrf
                    <div  class="form-group form-row mb-0">
                        <input type="search" name="text" required {{ isset($text) ? 'value='.$text : '' }} placeholder="recherche" class="col-10 form-control">
                        <button type="submit" id="submitForm" class="btn btn-outline-info pb-1 pt-1 col-2" >
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-sm-right">
                                    <a href="{{ route('admin.editAgent', ['agent' => $ag->matricule]) }}" class="dropdown-item">
                                    ...
                                    <form method="post" class="dropdown-item" action="{{ route('admin.destroyAgent', ['agent' => $ag->matricule]) }}" style="display: inline;">
                                        @csrf
                                        @method ('DELETE')
    ...
    <div>
        <div class="modal fade" id="fenetre2" tabindex="-1" aria-labelledby="fenetre2" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Importation une liste d'agents</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="text-center">Contenu du fichier Excel <br>(Matricule-Nom-Prénom-Poste-Categorie-Email-Téléphone)</div>
                        <form class="mt-5" method="post" action="{{route('admin.storeAgent')}}" id="form" enctype="multipart/form-data">
                            @csrf
