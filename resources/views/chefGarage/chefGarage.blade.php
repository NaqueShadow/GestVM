                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-sm-right">
                                    @if($intervention->debut > today() && $intervention->statut)
                                        <form class="dropdown-item" method="post" action="{{ route('intervention.destroy', ['intervention' => $intervention->id]) }}" style="display: inline;">
                                            @csrf
                                            @method ('DELETE')
                                        ...
                                        <a class="dropdown-item" href="{{ route('intervention.edit', ['intervention' => $intervention->id]) }}">
                                    ...
                                    @if( $intervention->statut )
                                        <a class="dropdown-item" href="interventions/{{ $intervention->id }}">
                                            <button class="btn btn-link text-success" title="terminer l'intervention">
